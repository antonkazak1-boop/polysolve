...
const NAV_ITEMS = [
  ...
  { href: '/btc-strategy',    icon: '📊', label: 'BTC Strategy', badge: 'new' },
  { href: '/lol',             icon: '🎮', label: 'LoL Data',  badge: 'new' },
  { href: '/lol/golgg',        icon: '📈', label: 'GoL.gg',    badge: 'new' },
  { href: '/lol/golgg/stats',  icon: '🗄️', label: 'GoL Stats',  badge: 'new' },
  { href: '/lol/golgg/predictor', icon: '🎲', label: 'Predictor', badge: 'new' },
  { href: '/lol/draft',         icon: '🧩', label: 'Draft',     badge: 'new' },
